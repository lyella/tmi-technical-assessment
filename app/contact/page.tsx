    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-fade-in">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-white border border-gray-200 rounded-sm p-8">
          ...
          {submitted ? (
            <div className="bg-gray-50 border border-gray-900 rounded-sm p-6 text-center animate-fade-in">
              <svg className="w-16 h-16 text-gray-900 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" />
              </svg>
              <h3 className="text-xl font-medium text-gray-900 mb-2">Message Sent!</h3>
              <p className="text-gray-600 font-light">Thank you for contacting us. We'll get back to you soon.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gray-900 text-white py-3 px-6 rounded-sm hover:bg-gray-800 transition-all duration-300 font-medium"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-light">support@tmistore.com</p>
                  <p className="text-gray-600 font-light">sales@tmistore.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-light">Mon-Fri: 9AM - 6PM EST</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 font-light">123 Commerce Street</p>
